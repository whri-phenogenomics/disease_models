load_phenodigm <- function() {
  phenodigm_df <- read.fst("data/phenodigm_matches_dr20.1.fst")
...
load_phenodigm_other <- function() {
  phenodigm_other_df <- read.fst("data/phenodigm_other_dr20.1.fst")
...
load_gene_summary <- function() {
  gene_summary_df <- read.fst("data/gene_summary_dr20.1.fst")
